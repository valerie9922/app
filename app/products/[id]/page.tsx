...
export default function ProductDetail({ params }: { params: { id: string } }) {
  ...
  if (!product) {
    return (
      <div className="min-h-screen bg-orange-50 dark:bg-gray-900 pt-20">
        <Navbar />
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-center">
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">商品未找到</h1>
          <Link href="/products" className="mt-4 inline-block text-orange-600 hover:text-orange-800">
            返回产品列表
          </Link>
        </div>
        <Footer />
